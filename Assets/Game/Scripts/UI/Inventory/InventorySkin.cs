...
namespace PlanetSurvival.UI.Inventory
{
    ...
    {
        [Header("Slot frame")]
        [SerializeField, Tooltip("Frame drawn behind every slot. Scaled to the slot, so it should stay square.")]
        ...
        public void Configure(Texture2D slotBackground, float iconPadding)
        {
